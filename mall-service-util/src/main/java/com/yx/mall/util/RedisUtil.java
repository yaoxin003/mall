...
public class RedisUtil {
    ...
    private JedisPool jedisLockPool;
    ...
    public void initLockPool(String host,int port,int database){
        JedisPoolConfig poolConfig = this.initPoolConfig(host,port,database);
        jedisLockPool = new JedisPool(poolConfig,host,port,TIME_OUT);
    }
    ...
    public Jedis getLockJedis() {
        Jedis jedis = jedisLockPool.getResource();
        return jedis;
    }
}
